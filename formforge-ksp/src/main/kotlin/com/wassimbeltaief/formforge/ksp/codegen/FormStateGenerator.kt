...
private val formStateHolderClass = ClassName("com.wassimbeltaief.formforge.core", "FormStateHolder")
...
internal class FormStateGenerator {
    ...
    fun generate(schema: SchemaModel): FileSpec {
        ...
        val holderClass = ClassName(schema.packageName, "${schema.schemaClassName}Holder")
    ...
    private fun buildHolderClass(
        ...
        return TypeSpec.classBuilder(holderClass)
            .addSuperinterface(formStateHolderClass.parameterizedBy(schemaClass))
